<template>
  <div class="copyable-textarea">
    <div class="header">
      ...
      <el-button type="primary" size="small" @click="copySelectedOrAll" icon="CopyDocument" plain> 复制 </el-button>
    </div>
...
const highlightedCode = computed(() => hljs.highlight(props.content || '', { language: 'sql' }).value);
