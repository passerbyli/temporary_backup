<template>
    <el-container class="app-shell">
        <el-header class="app-header">
            <component :is="component" title="订单系统" :menus="menus" :activeKey="activeKey" :user="user"
                @menu-click="onMenuClick" @logout="onLogout" />
        </el-header>
...
import TopNavBridge from "../components/TopNavBridge.vue";
export default {
    name: "Layout",
    components: { ContentRenderer, TopNavBridge },
    ...
    mounted() {
        this.component = TopNavBridge;
    },
    methods: {
        onMenuClick(m) {
            console.log("menu-click", m);
        },
        onLogout() {
            console.log("logout");
        },
